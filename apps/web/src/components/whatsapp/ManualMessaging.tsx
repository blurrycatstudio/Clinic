...
export function ManualMessaging() {
  ...
  return (
    <Card className="flex h-160 min-w-0 flex-1 flex-row gap-0 overflow-hidden rounded-2xl border p-0 shadow-none">
      {/* Contacts list */}
      <div className="flex w-67.5 shrink-0 flex-col border-r">
        <div className="border-b p-4">
          <h3 className="font-heading mb-2.5 text-[15px] font-bold">{t.waManualTitle}</h3>
